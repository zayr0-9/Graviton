...
/**
 * Determine if command should execute through WSL
 * Only true when running on Windows - on macOS/Linux tools run natively
 */
export function shouldUseWSL(): boolean {
  return isWindows()
}
