// electron/headlessServer/config/settingsStore.ts
...
import type { KeyValueStore } from '../../server/hostCapabilities.js'
import { tryGetHostCapabilities } from '../../server/serverHost.js'
